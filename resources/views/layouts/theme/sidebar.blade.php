        ...
        <li class="">
                <a href="#homeSubmenuStock" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="text-center">
                        <i class="fa fa-calendar-check fa-3x text-muted" aria-hidden="true"></i>
                        <div class=" text-center">
                            <span class="text-white">GESTION DE STOKS</span>
                        </div>
                    </div>
                </a>
                <ul class="collapse list-unstyled text-center text-white text-lg mt-2" id="homeSubmenuStock">
                    @can('Category_Index')
                    <li>
                        <a class="text-white" href="{{url('categories')}}">CATEGORIAS</a>
                        <i class="fa fa-tags fa-2x text-muted text-center" aria-hidden="true" style="vertical-align: middle;"></i>
                    </li>
                    @endcan
                    @can('Product_Index')
                    <li class="mt-2">
                        <a class="text-white" href="{{url('products')}}">PRODUCTOS</a>
                        <i class="fa fa-shopping-basket fa-2x text-muted" aria-hidden="true" style="vertical-align: middle;"></i>
                    </li>
                    @endcan
                    @can('Denominaciones_Index')
                    <li class="mt-2">
                        <a class="text-white" href="{{url('coins')}}">MONEDAS</a>
                        <i class="far fa-money-bill-alt fa-2x text-muted" aria-hidden="true" style="vertical-align: middle;"></i>
                    </li>
                    @endcan
                </ul>
            </li>
            ...
            <li class="">
                ...
                <ul class="collapse list-unstyled text-center text-white text-lg" id="homeSubmenuUser">
                    @role('Admin')
                    <li class="mt-2">
                        <a class="text-white" href="{{ url('roles') }}">ROLES</a>
                        <i class="fa fa-street-view fa-2x text-muted text-center" aria-hidden="true" style="vertical-align: middle;"></i>
                    </li>
                    @endcan
                    @role('Admin')
                    <li class="mt-2">
                        <a class="text-white" href="{{ url('permisos') }}">PERMISOS</a>
                        <i class="fa fa-unlock-alt fa-2x text-muted" aria-hidden="true" style="vertical-align: middle;"></i>
                    </li>
                    @endcan
                    @role('Admin')
                    <li class="mt-2">
                        <a class="text-white" href="{{ url('asignar') }}">ASIGNAR</a>
                        <i class="fa fa-check-square fa-2x text-muted" aria-hidden="true" style="vertical-align: middle;"></i>
                    </li>
                    @endcan
                    @role('Admin')
                    <li class="mt-2">
                        <a class="text-white" href="{{ url('users') }}">USUARIOS</a>
                        <i class="fa fa-user fa-2x text-muted" aria-hidden="true" style="vertical-align: middle;"></i>
                    </li>
                    @endcan
                </ul>
            </li>
