                ...
                <div class="card simple-title-task ui-sortable-handle">
                    <div class="card-body">
                        <div class="input-group input-group-md mb-3">
                            ...
                            <input type="number" id="cash" wire:mode="efectivo" wire:keydown.enter="saveSale"
                    ...
                    <div class="row justify-content-between mt-5">
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            @if($total > 0)
                            <button onclick="Confim('','clearCart','?SEGURO DE ELIMINAR EL CARRITO')" class="btn btn-dark mtmobile">
                                CANCELAR F4
                            </button>
                            @endif
                        </div>
